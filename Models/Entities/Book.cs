...
public class Book : Entity
{
    ...
    public virtual List<User> AddedInLibrary { get; set; } = new();
    public virtual List<User> AddedInFavorites { get; set; } = new();
    public virtual List<User> BoughtBooks { get; set; } = new();
